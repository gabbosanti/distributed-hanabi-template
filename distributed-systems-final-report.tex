...
\begin{itemize}
  ...
  \begin{itemize}
    \item \textbf{Acceptance Criterion:} When the game ends (e.g., there are no cards left, or the number of misfires exceeds 3), all clients receive a notification with the final game state and the outcome (win/loss).    
  \end{itemize}
