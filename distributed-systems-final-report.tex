...
\subsection{Infrastructure}\label{infrastructure}
  ...
  \scriptsize{
  Are there \emph{infrastructural components} that need to be introduced? \emph{how many}?
  \begin{itemize}
  ...
  As anticipated in section \ref{architecture}, the distributed system is composed by three component :
    \begin{itemize}
      \item multiple client
      \item game server, one for each game, which is spawned as a docker containerization
      \item redis database, composed of master and replica
  \end{itemize}
